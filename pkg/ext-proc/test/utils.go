...
func StartExtProc(port int, refreshPodsInterval, refreshMetricsInterval, refreshMetricsTimeout time.Duration, pods []*backend.PodMetrics, models map[string]*v1alpha1.InferenceModel) *grpc.Server {
	...
	if err := pp.Init(refreshPodsInterval, refreshMetricsInterval, refreshMetricsTimeout); err != nil {
